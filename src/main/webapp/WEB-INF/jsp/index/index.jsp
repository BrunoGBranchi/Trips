...
<div class="navbar navbar-light bg-light fixed-top navbar-expand-md" role="navigation">
    <div class="container">
        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target=".navbar-collapse">&#x2630;</button> <a target="_blank" href="#" class="navbar-brand">Trips.</a>
        <div
                            ...
                            <div class="navbar-login">
                                <div class="row">
                                    <div class="offset-xl-3 col-xl-12">
                                        <img src="https://via.placeholder.com/110" class="img-responsive rounded-circle img-thumbnail">
                                        </p>
                                    </div>
                                    <div class="col-xl-12">
                            ...
                            <div class="navbar-login navbar-login-session">
                                <div class="row mx-md-n5">
                                    <div class="col px-md-5">
                                        <p class="text-center"> <a href="#" class="btn btn-light btn-outline-dark"><i class="fas fa-cog"></i></a>
                                    </div>
                                    <div class="col px-md-5">
                                    	<form action="/logout"></form>
                                        <p> <a type="submit" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
